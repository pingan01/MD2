...
public class RenderCaps {
    ...
    static void setRenderCaps(GL10 $gl) /* package-private*/ {
        ...
        Log.e("TAG", "_maxTextureUnits==" + _maxTextureUnits);
        ...
        Log.e(Min3d.TAG, "RenderCaps - openGLVersion: " + _openGlVersion);
        Log.e(Min3d.TAG, "RenderCaps - maxTextureUnits: " + _maxTextureUnits);
        Log.e(Min3d.TAG, "RenderCaps - maxTextureSize: " + _maxTextureSize);
        Log.e(Min3d.TAG, "RenderCaps - maxLights: " + _maxLights);
    }
}
