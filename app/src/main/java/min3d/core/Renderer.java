...
public class Renderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl) {
        Log.e(Min3d.TAG, "Renderer.onDrawFrame()");
    ...
    protected void drawSetup() {
        // View frustrum
        Log.e("TAG","_scene.camera().frustum.isDirty()=="+_scene.camera().frustum.isDirty());
        ...
        Log.e("TAG","_scene.camera().position.x=="+_scene.camera().position.x+"\n"+"_scene.camera().position.y=="+_scene.camera().position.y+"\n"+" _scene.camera().position.z=="+_scene.camera().position.z);
        Log.e("TAG","_scene.camera().target.x=="+_scene.camera().target.x+"\n"+"_scene.camera().target.y"+_scene.camera().target.y+"\n"+"_scene.camera().target.z"+_scene.camera().target.z);
        Log.e("TAG","_scene.camera().upAxis.x=="+_scene.camera().upAxis.x+"\n"+"_scene.camera().upAxis.y"+_scene.camera().upAxis.y+"\n"+"_scene.camera().upAxis.z"+_scene.camera().upAxis.z);
        // Background color
        Log.e("TAG","_scene.backgroundColor().isDirty()=="+_scene.backgroundColor().isDirty());
    ...
    protected void drawSetupLights() {
        ...
        Log.e("TAG","lights.length=="+lights.length);
    ...
    private void doFps() {
        ...
        if (delta >= FRAMERATE_SAMPLEINTERVAL_MS) {
            ...
            _activityManager.getMemoryInfo(_memoryInfo);
            Log.e(Min3d.TAG, "FPS: " + Math.round(_fps) + ", availMem: " + Math.round(_memoryInfo.availMem / 1048576) + "MB");
