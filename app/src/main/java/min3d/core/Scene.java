...
public class Scene implements IObject3dContainer, IDirtyParent
{
	...
	*/
	...
	{
		Log.e(Min3d.TAG, "Scene.init()");
		
		this.reset();
		Log.e("TAG 1", "_sceneController==" + _sceneController);
		_sceneController.initScene();
		Log.e("TAG 2", "_sceneController==" + _sceneController);
		_sceneController.getInitSceneHandler().post(_sceneController.getInitSceneRunnable());
		Log.e("TAG 3", "_sceneController==" + _sceneController);
	}
